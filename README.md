...
* [PDF Dark](https://github.com/1436941541/pdf-dark): converts PDF files to dark mode in the browser, preserving photos
  and charts via saturation-based pixel classification
